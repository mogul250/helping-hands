      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <a href="#donate" className="bg-gradient-to-r from-terracotta-500 to-terracotta-600 text-white px-6 py-3 rounded-full hover:from-terracotta-600 hover:to-terracotta-700 transition-all duration-300 shadow-md hover:shadow-lg transform hover:scale-105 inline-block">Donate</a>
          </div>
        ...
        {isOpen && (
          <div className="md:hidden bg-white shadow-lg rounded-lg mt-2">
            <div className="px-4 pt-4 pb-6 space-y-3">
              ...
              <a href="#donate" className="w-full bg-gradient-to-r from-terracotta-500 to-terracotta-600 text-white px-6 py-3 rounded-full hover:from-terracotta-600 hover:to-terracotta-700 transition-all duration-300 shadow-md inline-block text-center">Donate</a>
            </div>
          </div>
        )}
      </div>
